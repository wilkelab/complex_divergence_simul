...
all.data.B1 <- data.frame(names=name, ab.count=ab.count, ev.binding=ev.binding, an.binding=an.binding, stab=stab, 
                          chain=chain, replicate=replicate, set=rep('LS', length(replicate)))

survival.data.B1 <- data.frame(x=1:1000, y=rowMeans(as.data.frame(split(survival, survival.replicate))))
...
all.data.B2 <- data.frame(names=name, ab.count=ab.count, ev.binding=ev.binding, an.binding=an.binding, stab=stab, 
                          chain=chain, replicate=replicate, set=rep('LS', length(replicate)))

survival.data.B2 <- data.frame(x=1:1000, y=rowMeans(as.data.frame(split(survival, survival.replicate))))
...
all.data.B3 <- data.frame(names=name, ab.count=ab.count, ev.binding=ev.binding, an.binding=an.binding, stab=stab, 
                          chain=chain, replicate=replicate, set=rep('LS', length(replicate)))

survival.data.B3 <- data.frame(x=1:1000, y=rowMeans(as.data.frame(split(survival, survival.replicate))))
...
all.data.B4 <- data.frame(names=name, ab.count=ab.count, ev.binding=ev.binding, an.binding=an.binding, stab=stab, 
                          chain=chain, replicate=replicate, set=rep('LS', length(replicate)))

survival.data.B4 <- data.frame(x=1:1000, y=rowMeans(as.data.frame(split(survival, survival.replicate))))

survival.data <- data.frame(x=rep(1:1000, 4), y=c(survival.data.B1$y, survival.data.B2$y, survival.data.B3$y, survival.data.B4$y), 
                            replicate=c(rep('b1',1000), rep('b2', 1000), rep('b3', 1000), rep('b4', 1000)))
